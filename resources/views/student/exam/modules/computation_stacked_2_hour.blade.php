																	...
																	<table border="0" >
																		<tr>
																			<dt style="visibility:hidden;">
																				<input onclick="javascript:selectingEquation('1','X');" value="1" id="input_radio_equation_1" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">日-時</span></input>																				
																			</dt>
																			<dt >
																				<input onclick="javascript:selectingEquation('2','X');" value="2" id="input_radio_equation_2" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">時-分</span></input>
																			</dt>
																			<dt style="visibility:hidden;">
																				<input onclick="javascript:selectingEquation('3','X');" value="3" id="input_radio_equation_3" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">分-秒</span></input>
																			</dt>
																			<dt style="visibility:hidden;">
...
function selectingEquation(type, operator){
	switch(type){
		...
		case '3':
			...
			document.getElementById('cel_0_19').innerHTML = '秒';
	...
	switch(global_caltype){
		...
		case 2:			
			...
			//007 新加 為了配合 AT 使用 去除 R 的部分 直接覆蓋 學生輸入錯的答案
				...
				var back_st_3 = document.getElementById('input_hidden_response').value.length - 15; 
				//alert(document.getElementById('input_hidden_response').value.substr(0,back_st_3));
				var stu_st_anw = document.getElementById('input_hidden_response').value.substr(0,back_st_3);
				back_c = 1; //AT 
