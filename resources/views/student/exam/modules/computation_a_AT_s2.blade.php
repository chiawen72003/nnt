														...
														<table align="left" >
															<tr>
																<td>
																			...
																			<font size = "6" color="#a52a2a" style="font-family:標楷體;" >請點選下方選項</font><br>
																			<font style="font-family:標楷體;" > 選擇題答案: </font>
																			<textarea name="latex_Code1" id="latex_Code1" style="resize:none;height:30px;width:30px;" readonly="readonly"></textarea>
															...
															<tr bgcolor="#FFFF99">
																<td>
																	<table border="0">
																		...
																		<tr>
																			<td >
																				<input id="input_choose_number_6" style="font-family:標楷體;font-size:15px;" onclick="javascript:insert_math1('(6)');" value="重新選擇" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" >
																			</td>
																		</tr>
																	</table>
																</td>
															...
															<div id ="latex_proxy" align ="right" >
																	...
																	<br>
																	<textarea name="math_Semantic" id="math_Semantic" style="resize:none;height:75px;width:30%;display:none" ></textarea>
