															...
															<tr>
																<td>
																	<table border="0" >
																		<tr>
																			<dt>
																				<input onclick="javascript:selectingEquation('1','＋');" value="1" id="input_radio_equation_1" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">加法</span></input>																				
																				<dt>
																					<input onclick="javascript:selectingEquation('2','－');" value="2" id="input_radio_equation_2" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">減法</span></input>
																				</dt>
																				<dt>
																					<input onclick="javascript:selectingEquation('3','X');" value="3" id="input_radio_equation_3" name="input_radio_equation" type="radio" style=""><span style="font-size:12px;">乘法</span></input>
																				</dt>
																			<dt>
...
function selectingEquation(type, operator){
	switch(type){
		case '1':
			...
			document.getElementById('img_line_1').style.visibility = 'visible';
			document.getElementById('img_divisionline_1').style.visibility = 'hidden';
			...
			//document.getElementById('button_finishing_step1OfEquation123').style.visibility = 'visible';
			//document.getElementById('button_finishing_step1OfEquation4').style.visibility = 'hidden';			
		break;
		case '2':
			global_caltype = 2;			
			//document.getElementById('span_operator').innerHTML = operator;
...
function finishing2_4(btn){
	...
	switch(global_caltype){
		case 1:
			document.getElementById('img_line_6').style.visibility = 'visible';
			for(var i=0;i<11;i++){
				for(var j=0;j<13;j++){
					var text_id = 'input_text_r_'+ (i+1)+ '_'+ (j+1);
					var input_text = document.getElementById(text_id);	
