                                    ...
                                    <table align="left" >
                                     ...
                                     <br>
                                      <!--嘗試-->
                                         ...
                                         <tr>
                                         <td>
                                              <table border="0"bgcolor="#FFFF99" align="left">
            																		<tr >
            																			<td width="50">
                                                  ...
                                                  <td>
                                                    		<input type="button"  onclick="javascript:insert_math('{/}lim_{ \\to }')" style="background-image:url(include/image/lim.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
        																							</td>		
        																							<td>
        																								<input type="button"  onclick="javascript:insert_math('{/}varrho^{ }')" style="background-image:url(include/image/e.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																			
        																							</td>
                                                   	<td>
        																								<input type="button"  onclick="javascript:insert_math('∞')" style="background-image:url(include/image/infty.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																			
        																							</td>
                                                         <td>
        																								<input type="button"  onclick="javascript:insert_math('{/}left|\\right|')" style="background-image:url(include/image/abs.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																			
        																							</td>  
        																						...
        																						<td colspan="2">
        																								<input type="button"  onclick="javascript:insert_math('存在')" style="background-image:url(include/image/exist.png);width:54px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																			
        																							</td>
                                                      <td colspan="2">
        																								<input type="button"  onclick="javascript:insert_math('不存在')" style="background-image:url(include/image/noexist.png);width:64px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																			
        																							</td>	  																			
        																						</tr>
