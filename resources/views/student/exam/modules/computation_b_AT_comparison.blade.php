...
function upload_responses(){  //抓取答案
	...
	//alert(document.getElementById('math_textarea2').value);
	//var latexSource_co = document.getElementById('math_textarea2').value;
	var latexSource=$("#latex_Code"); //007 改 填充題
	var latexSource1=$("#latex_Code1");
	var Semantic=document.getElementById('math_Semantic').value; //語意作答 AT
	var Semantic_stu=document.getElementById('math_Semantic_stu').value; //語意發問 AT
	var stu_answer = '';
	...
	if((responses==0)&&(responses_short==0))
	{
			...
			//answer="*"+"選擇題答案:"+latexSource1.val()+"|"+latexSource_co.replace(/\s+/g, "")+"|"+"|";
			answer="*"+"選擇題答案:"+latexSource1.val()+"|"+latexSource.val()+"|"+"|"+Semantic.replace(/\s+/g, "")+"|"+Semantic_stu.replace(/\s+/g, "");
			//alert(stu_answer);
			//alert(latexSource_co.replace(/\s+/g, ""));
			answer_f="*"+"學生回答:"+Semantic+"\n"+"*學生發問："+Semantic_stu;
	...
	else 
	{
		...
		//answer="*"+"選擇題答案:"+latexSource1.val()+"|"+document.getElementById('math_textarea2').value+"|"+responses+"|"+responses_short;
		answer="*"+"選擇題答案:"+latexSource1.val()+"|"+latexSource_co.replace(/\s+/g, "")+"|"+responses+"|"+responses_short;
		answer_f="*"+"學生回答:"+latexSource_co;
