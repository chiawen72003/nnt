...
<div id="mwt_mwt_slider_scroll" style="visibility:hidden;">
		...
		<div id="mwt_slider_content" >
					<table valign="top" width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="display:none">
							<tbody>																
												<tr valign="middle" bgcolor="lightgreen" >													
													<td>
														<table align="center" style="display:none">														
															<tr>
																<td >
																	<font face="標楷體" size="3"align="center"><u><b>選擇題選項1</b></u></font>																	
																</td>
															</tr>
															<tr>
																<td>
																	<table border="0">
																		<tr>
																			<td >
																				<input id="input_choose_number_1" onclick="javascript:insert_math1('(1)');" value="(1)" name="alex" type="button"    style="width:35px;">
																				<input id="input_choose_number_2" onclick="javascript:insert_math1('(2)');" value="(2)" name="alex" type="button"    style="width:35px;">
																				<input id="input_choose_number_3" onclick="javascript:insert_math1('(3)');" value="(3)" name="alex" type="button"    style="width:35px;">
																				<input id="input_choose_number_4" onclick="javascript:insert_math1('(4)');" value="(4)" name="alex" type="button"    style="width:35px;">
																				<input id="input_choose_number_5" onclick="javascript:insert_math1('(5)');" value="(5)" name="alex" type="button"    style="width:35px;">
																			</td>
																		</tr>
																		<tr>
																			<td >
																				<input id="input_choose_number_6" onclick="javascript:insert_math1('(6)');" value="重新選擇" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" >
																			</td>
																		</tr>
																	</table>
																</td>
															...
															<tr>
																<td>
																	<!--  <font face="標楷體" size="3"align="center"><u><b>數字區(直式、橫式輸入)</b></u></font>	-->																
															...
															<tr>
																<td>
																	...
																	<table border="1"bgcolor="#FFFF99">
																		<tr >
																			<td width="35">
																				<input id="input_button_number_1" onclick="javascript:inputNumber('1');" value="1" name="alex" type="button"style="width:35px;" >
																			</td>
																			<td width="35">
																				<input id="input_button_number_2" onclick="javascript:inputNumber('2');" value="2" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_3" onclick="javascript:inputNumber('3');" value="3" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_4" onclick="javascript:inputNumber('4');" value="4" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_5" onclick="javascript:inputNumber('5');" value="5" name="alex" type="button" style="width:35px;">
																			</td>
																		</tr >
																		<tr>
																			<td width="35">
																				<input id="input_button_number_6" onclick="javascript:inputNumber('6');" value="6" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_7" onclick="javascript:inputNumber('7');" value="7" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_8" onclick="javascript:inputNumber('8');" value="8" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_9" onclick="javascript:inputNumber('9');" value="9" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_0" onclick="javascript:inputNumber('0');" value="0" name="alex" type="button" style="width:35px;">
																			</td>
																		</tr>
																		<tr >
																			<td width="35">
																				<input id="input_button_point" onclick="javascript:inputDot('.');" value="." name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_zero2" onclick="javascript:inputNumber('Ø');" value="Ø" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_threepoint" onclick="javascript:inputNumber('、、、');" value="餘" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_delete" onclick="javascript:delNumber();" value="←" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				&nbsp;
																			</td>
																		...
																		<tr bgcolor="#FF99CC">
																		 ...
																		 <tr >
																			<td width="35">
																				<input id="input_button_add" onclick="javascript:inputNumber('+');" value="+" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_sub" onclick="javascript:inputNumber('-');" value="-" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_times" onclick="javascript:inputNumber('×');" value="×" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_division" onclick="javascript:inputNumber('÷');" value="÷" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_equal" onclick="javascript:inputNumber('=');" value="=" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_null" onclick="javascript:inputNumber('☐');" value="☐" name="alex" type="button" style="width:35px;">
																			</td>
																		</tr>
																	</table> 
																	-->
															...
															<tr>
																<td>
																	<!-- <font face="標楷體" size="3"align="center"><u><b>數字區(化簡)</b></u></font>	-->																
															...
															<tr>
																<td>
																	...
																	<table border="1"bgcolor="#FFFF99">
																		<tr >
																			<td width="35">
																				<input id="input_button_number_1" onclick="javascript:inputNumber('❶');" value="❶" name="alex" type="button"style="width:35px;" >
																			</td>
																			<td width="35">
																				<input id="input_button_number_2" onclick="javascript:inputNumber('❷');" value="❷" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_3" onclick="javascript:inputNumber('❸');" value="❸" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_4" onclick="javascript:inputNumber('❹');" value="❹" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_5" onclick="javascript:inputNumber('❺');" value="❺" name="alex" type="button" style="width:35px;">
																			</td>
																		</tr >
																		<tr >
																			<td width="35">
																				<input id="input_button_number_6" onclick="javascript:inputNumber('❻');" value="❻" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_7" onclick="javascript:inputNumber('❼');" value="❼" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_8" onclick="javascript:inputNumber('❽');" value="❽" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_number_9" onclick="javascript:inputNumber('❾');" value="❾" name="alex" type="button" style="width:35px;">
																			</td>
																			<td width="35">
																				<input id="input_button_zero2" onclick="javascript:inputNumber('Ø');" value="Ø" name="alex" type="button" style="width:35px;">
																			</td>
												...
												<tr valign="middle" bgcolor="lightgreen">													
													<td>
														...
														<table align="center" border="0">
															<tr>
																<td >
																	<input id="input_button_recal" onclick="javascript:if(confirm('確定重新計算?')){recalculating();};" value="全部清空" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" style="width:90px;visibility:hidden;">																
																</td>
																<td>
																	<input id="input_button_btp" onclick="javascript:back_to_prestep();" value="回上一列" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" style="width:90px;visibility:hidden;">																
																	<input id="input_button_change" onclick="javascript:newline()" value="橫式換列" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" style="width:75px;visibility:hidden;">
																</td>																
															</tr>																																															
														</table>
												...
												<tr bgcolor="" style="visibility:hidden;">
													<td>
														<hr size="1" width="100%">
													</td>
												</tr>
												<tr valign="middle" bgcolor="lightgreen" style="visibility:hidden;">													
													<td>
														<table align="center" border="0" >
															<tr align="center">
																<td colspan="5">
															...
															<tr align="center" >
																...
																<td id="math_check1">
																	<input onclick="javascript:math_check1();" id="mathcheck1" name="mathcheck1" type="checkbox" ><font face="標楷體" size="3"align="center"><u><b>啟用橫式算式</b></u></font></input>
																</td>																
															</tr>
															<tr>
																 <td colspan="5">
																		<div align="center"><font face="標楷體" size="3"align="center"><u><b>(取消勾選回到直式模式)</b></u></font></div>
																 </td>
															</tr>																
														</table>														
													</td>
												...
												<tr id="math_computation1" valign="middle" bgcolor="lightgreen"   style = "display:none;overflow-y:auto;height:190px;overflow-x:hidden;visibility:hidden;">													
													<td height="">
														<table align="center">
															<tr>
																<td align="left">
										...
										<tr  id="math_computation2" valign="middle" bgcolor="lightgreen" style = "display:none;overflow-y:auto;height:200px;overflow-x:hidden;" >													
													<td height="">
														<table align="center">
															<tr>
																<td>
																	<font face="標楷體" size="3"align="center"><u><b>常用符號</b></u></font>
																</td>
															</tr>
															<tr>															
																<td align="left">																
																	<table>
																		<tr>
																			<td>	
																				<input type="button"  onclick="javascript:insert_math('(')" style="background-image:url(include/image/Open_parenthesis.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>																		
																			<td>
																				<input type="button"  onclick="javascript:insert_math(')')" style="background-image:url(include/image/Close_parenthesis.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('>')" style="background-image:url(include/image/is_more_than.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('<')" style="background-image:url(include/image/is_less_than.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('{/}ge')" style="background-image:url(include/image/ge.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >
																			</td>
																			<td>																				
																				<input type="button"  onclick="javascript:insert_math('{/}le')" style="background-image:url(include/image/le.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>																			
																		</tr>
																		<tr>
																			<td>
															...
															<tr>
																<td >																													
																<!--移除除法的1/2-->
																	<input type="button"  onclick="javascript:insert_math('{/}frac{}{}')" style="background-image:url(include/image/frac.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																</td>
															</tr>
															<tr>
																<td>
																	<font face="標楷體" size="3"align="center"><u><b>常用單位</b></u></font>
																</td>
															</tr>
															<tr>															
																<td align="center">																
																	<table>
																		<tr>
																			<td>																				
																				<input type="button"  onclick="javascript:insert_math('包')" style="background-image:url(include/image/bale.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('個')" style="background-image:url(include/image/PCS.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('塊')" style="background-image:url(include/image/Block.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('周')" style="background-image:url(include/image/cycle.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('顆')" style="background-image:url(include/image/Stars.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('條')" style="background-image:url(include/image/Strip.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >
																			</td>		
																		</tr>																		
																	</table>
																</td>
															...
															<tr>
																<td align="left">																
																	<table>
																		<tr>
																			<td>																				
																				<input type="button"  onclick="javascript:insert_math('公里')" style="background-image:url(include/image/km.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('公尺')" style="background-image:url(include/image/m.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('公分')" style="background-image:url(include/image/cm.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>		
																		</tr>																		
																	</table>
																</td>
															...
															<tr>
																<td align="left">																
																	<table>
																		<tr>
																			<td>																				
																				<input type="button"  onclick="javascript:insert_math('日')" style="background-image:url(include/image/day.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('時')" style="background-image:url(include/image/hr.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('分')" style="background-image:url(include/image/min.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('秒')" style="background-image:url(include/image/sec.png);width:34px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>			
																		</tr>																		
																	</table>
																</td>
															...
															<tr>
																<td align="left">																
																	<table>
																		<tr>
																			<td>																				
																				<input type="button"  onclick="javascript:insert_math('平方公尺')" style="background-image:url(include/image/m2.png);width:55px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
																				<input type="button"  onclick="javascript:insert_math('平方公分')" style="background-image:url(include/image/cm2.png);width:55px;height:37px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																			</td>
																			<td>
...
function upload_responses(){  //抓取答案
	...
	if((responses==0)&&(responses_short==0))
	{
			...
			answer="*"+"選擇題答案:"+latexSource1.val()+"|"+latexSource.val()+"|"+"|";
			//alert(stu_answer);
			answer_f="*"+"學生回答:"+latexSource1.val();
