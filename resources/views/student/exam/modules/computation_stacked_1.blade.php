...
background:url(http://www.sitmo.com/gg/latex/img/corner_tr.gif) 100% -12px no-repeat;}</style>
														...
														<table align="left" border="0" width="600px" cellpadding="0" cellspacing="0">
															<tr>
																<td>&nbsp;
																</td>
																<td align="center">
																	<table border="0" cellpadding="0" cellspacing="0">
																		...
																		<tr id="row_4">
																			...
																			<td id="cel_4_10" width="10">
																				<div id="div_operator">
																				<!--<img id="img_2" border="0" src="images/line2.gif" style="visibility:hidden;">!-->
																				</div>
																				<!--<span id="span_operator" style=""></span>-->
																			</td>
																			...
																			<td id="cel_4_23" align="right" width="30">
																				&nbsp;
																			...
																			<td id="cel_4_25" align="right" width="30">
																				&nbsp;
																		...
																		<tr id="row_7">
																			...
																			<td id="cel_7_10" valign="top" width="10">																				
																		...
																		<!--
																		<tr id="row_8" height="10">																			
																			<td valign="bottom" colspan="26">8																
																			</td>																			
																		</tr>
																		!-->
																		<tr id="row_9">
														...
														<table width = "300px">
																				...
																				<!--學生發問 對話框 -->
																						<div id="math_box" align ="center" >
																							<!--橫式算式:<br>-->
																							
																							<!--style="border-style:none;" -->
																								<span id="math_textarea" onclick="javascript:get_math(this);" style="height:75px;width:265px;" ></span>
																								<br>
																								<font size = "6" color="#a52a2a" style="font-family:標楷體;" >我有問題想發問</font>
																								<br>
																								<textarea name="math_Semantic" id="math_Semantic" style="resize:none;height:75px;width:265px;" ></textarea>
																						</div>
																						<center>
																							<input id="input_button_upload_response" value="作答完畢，進入下一題" name="upload2" class="butn01" type="button" onclick="javascript:upload_responses();">
														...
														<!--<center>
															<input id="input_button_upload_response" value="作答完畢，進入下一題" name="upload" class="butn01" type="button" onclick="javascript:upload_responses();">
															<input type="hidden" id="input_hidden_response" name="input_hidden_response"></input>
															<input type="hidden" id="input_hidden_response2" name="input_hidden_response2"></input>
														</center>-->
													</form>
