...
background:url(http://www.sitmo.com/gg/latex/img/corner_tr.gif) 100% -12px no-repeat;}</style>		
														...
														<p>
														<!--<font size = "6" color="#a52a2a" style="font-family:標楷體;" >作答請用左邊的功能選單</font><br>-->
														<table align="left" >
															<tr>
																<td style="width:650;">
																	
																		
																			<font size = "6" color="#a52a2a" style="font-family:標楷體;" >作答請點選下方按鈕</font><br>
																			<font size = "6" color="#000000" style="font-family:標楷體;" >選擇題答案:</font>
																			<textarea name="latex_Code1" id="latex_Code1" style="resize:none;height:50px;width:50px;font-size:25px;color:#000000;" readonly="readonly"></textarea>
																		
																		<!--<li>
																			<textarea name="latex_Code1" id="latex_Code1" style="height:30px;width:30px;"></textarea>
																		</li>-->
                              ...
                              <?php 
                                      ...
                                      if($_SESSION['cs_id']=='000'){ ?>
                                      
                                    <div align ="left" style="width:300;" style="display:block" >
  																	<!--<textarea name="math_semantic" id="math_semantic" style="height:75px;width:330px;resize:none;border:3px #00C700 solid;-color:#9999FF;" ></textarea>-->
  																	<textarea name="math_Semantic" id="math_semantic" style="resize:none;height:75px;width:330px;resize:none;border:3px #00C700 solid;-color:#9999FF;" ></textarea>
                                    </div>                                   
                                   ...
                                   <br>
                                   <?php 
                                $st = substr($_SESSION['cs_id'], 0, 3);
                                if($st == '020'){
                                     echo '<div align ="right" >';
                                }else{
                                     echo '<div align ="right" style="width:645px;">';
                                }
                              ?>                              
															...
															<tr>
																<td >
																	<font face="標楷體" size="5" align="center" style="font-family:標楷體;" ><u><b>選擇題選項</b></u></font>																	
																</td>
															</tr>
															<tr bgcolor="#FFFF99">
																<td>
																	<table border="0">
																		<tr>
																			<td >
																				<input id="input_choose_number_1" onclick="javascript:insert_math1('(1)');" value="(1)" name="alex" type="button"    style="width:50px;">
																				<input id="input_choose_number_2" onclick="javascript:insert_math1('(2)');" value="(2)" name="alex" type="button"    style="width:50px;">
																				<input id="input_choose_number_3" onclick="javascript:insert_math1('(3)');" value="(3)" name="alex" type="button"    style="width:50px;">
																				<input id="input_choose_number_4" onclick="javascript:insert_math1('(4)');" value="(4)" name="alex" type="button"    style="width:50px;">
                                        <input id="input_choose_number_5" onclick="javascript:insert_math1('(5)');" value="(5)" name="alex" type="button"    style="width:50px;">
																				<!--<input id="input_choose_number_5" onclick="javascript:insert_math1('(5)');" value="(5)" name="alex" type="button"    style="width:35px;">-->
																			</td>
																		</tr>
																		<tr>
																			<td >
																				<input id="input_choose_number_6" style="font-family:標楷體;width:100px;height:50px;font-size:20px;" onclick="javascript:insert_math1('(6)');" value="重新選擇" name="alex" type="button" class="groovybutton"  onMouseOver="javascript:goLite(this.form.name,this.id)" onMouseOut="javascript:goDim(this.form.name,this.id)" >
																			</td>
																		</tr>
																	</table>
																</td>
															...
															<div id ="latex_proxy" align ="right" >
																	<textarea name="latex_as" id="latex_as" style="height:150px;width:290px;" ><?php echo $_POST["latex_as"] ?> </textarea>
															</div>
															-->
															<tr>
																<td >
																	<!--<div align ="left" >
																			...
																			<br>
																			<textarea name="math_Semantic" id="math_Semantic" style="resize:none;height:75px;width:600px;" ></textarea>
																	</div>-->
                              ...
                              <tr align ="left">
															...
															<div id ="latex_proxy" align ="right" >
																	...
																	?>
																	<textarea name="latex_as" id="latex_as" style="resize:none;height:150px;width:30%;display:none;" readonly="readonly" ><?php echo $feedback_talk; ?></textarea>
																	 
                                  
                                  <br>
																	<center style="width:30%;display:none"">
																	<font size = "6" color="#a52a2a" style="font-family:標楷體;" align ="left" >我有問題想發問</font>
																	</center>
																	<br>
