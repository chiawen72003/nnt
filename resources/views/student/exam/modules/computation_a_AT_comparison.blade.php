...
function startButton(event) {
  ...
  textBox = document.getElementById("math_Semantic"); // 取得最終的辨識訊息控制項 textBox
...
background:url(http://www.sitmo.com/gg/latex/img/corner_tr.gif) 100% -12px no-repeat;}</style>		
                                  ...
                                  <label id="infoBox"></label>
																...
																<br>
																<div id="math_box" align ="left" style="width:100%;">
																<!--橫式算式:-->
																<br>
																<!--style="border-style:none;" -->
																	<!--<textarea name="math_textarea2" id="math_textarea2" style="resize:none;height:150px;width:600px;" ></textarea>-->
																	<textarea name="math_Semantic" id="math_Semantic" style="resize:none;height:75px;width:550px;" ></textarea> 
																</div>
																	...
																	<textarea name="latex_as" id="latex_as" style="resize:none;height:150px;width:30%;" readonly="readonly" ></textarea>
																				...
																				<table align="right" width="30%" >
																									<tr>
																										<td>
																										  <!--學生發問 對話框 -->
            																						<div id="math_box2" align ="right" style="height:150px;width:100%;display:none";">
            																							<!--橫式算式:<br>-->
            																								...
            																								<table align="right" width="30%" >
            																									<tr>
            																										<td>
            																											...
            																											<br>
            																											<textarea name="math_Semantic_stu" id="math_Semantic_stu" style="resize:none;height:75px;width:100%;" ></textarea>
            																										</td>
            																									</tr>
            																								</table>
            																								<center>
...
@endif	
                                                    ...
                                                    <br>
                                                        ...
                                                        <input type="hidden" id="input_hidden_response" name="input_hidden_response"></input>
                        																...
                        																<input type="hidden" id="input_hidden_shortresponse2" name="input_hidden_shortresponse2"></input>
                        																<input type="hidden" id="input_hidden_stu_answer" name="input_hidden_stu_answer"></input>-->
                                                        <!--<a href="http://120.108.208.83/bnat_test/modules.php?op=main" target="_blank"><span>回到首頁</span></a>-->
