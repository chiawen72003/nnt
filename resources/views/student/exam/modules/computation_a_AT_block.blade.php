...
background:url(http://www.sitmo.com/gg/latex/img/corner_tr.gif) 100% -12px no-repeat;}</style>		
														...
														<table align="left" >
															...
															<tr>
																<td>
																	<font size = "6" color="#a52a2a" style="font-family:標楷體;" >作答請用左邊的功能選單</font>
																...
																<!--style="border-style:none;" -->
																	<span id="math_textarea" onclick="javascript:get_math(this);" style="height:75px;width:500px;" ></span>
																	<br>
                                  <!--嘗試-->
                                     ...
                                     <td> 
                                        <table align="center" bgcolor="#00FF99">
    																			<tr>
    																				<td width="35">
    																			...
    																			<tr>															
    																				<td align="left">																
    																					<table>
    																						<tr>
    																							<td>	
    																								<input type="button"  onclick="javascript:insert_math('(')" style="background-image:url(include/image/Open_parenthesis.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
    																							</td>																		
    																							<td>
    																								<input type="button"  onclick="javascript:insert_math(')')" style="background-image:url(include/image/Close_parenthesis.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
    																							</td>
    																							<td>
    																								<input type="button"  onclick="javascript:insert_math('>')" style="background-image:url(include/image/is_more_than.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
    																							</td>
    																							<td>
    																								<input type="button"  onclick="javascript:insert_math('<')" style="background-image:url(include/image/is_less_than.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
    																							</td>
    																							<td>
    																								<input type="button"  onclick="javascript:insert_math('{/}ge')" style="background-image:url(include/image/ge.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >
    																							</td>
    																							<td>																				
    																								<input type="button"  onclick="javascript:insert_math('{/}le')" style="background-image:url(include/image/le.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
    																							</td>																			
    																						</tr>
    																						<!--
    																						<tr>
                                            ...
                                            <tr>
																					...
																					<td>
																						...
																						<tr>
                                              <td>
                                                <input type="button"  onclick="javascript:insert_math('{/}frac{}{}')" style="background-image:url(include/image/frac.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >
                                              </td>
                                              <td>																				
																								<input type="button"  onclick="javascript:insert_math('公里')" style="background-image:url(include/image/km.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																								<input type="button"  onclick="javascript:insert_math('公尺')" style="background-image:url(include/image/m.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																								<input type="button"  onclick="javascript:insert_math('公分')" style="background-image:url(include/image/cm.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																							</td>
																							<td>																				
																								<input type="button"  onclick="javascript:insert_math('日')" style="background-image:url(include/image/day.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																								<input type="button"  onclick="javascript:insert_math('時')" style="background-image:url(include/image/hr.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																								<input type="button"  onclick="javascript:insert_math('分')" style="background-image:url(include/image/min.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																								<input type="button"  onclick="javascript:insert_math('秒')" style="background-image:url(include/image/sec.png);width:25px;height:28px;background-repeat:no-repeat;background-position:center;background-color:white;" >																				
																							</td>
																						</tr>
                                ...
                                <td valign="top">
														<div id ="latex_proxy" align ="right"  >
																	<textarea name="latex_as" id="latex_as" style="resize:none;height:150px;width:300;" readonly="readonly" valign="top" ></textarea>
																	<br>
																	<center style="width:300;" style="display:none">
																	<font size = "6" color="#a52a2a" style="font-family:標楷體;display:none" >我有問題想發問</font>
																	</center>
																	<br>
																	<textarea name="math_Semantic" id="math_Semantic" style="display:none" ></textarea>
														</div>
														<div align ="right">
																<!--<center>-->
